...
I want to showcase the relationship between arts intervention and incarceration to create a narrative that properly allocated and funded arts education programs could help reduce juvenile detention rates. This story would explore the tangled history of incarceration in the United States and how we have relied on a system of punishment rather than rehabilitation. The audience of this story includes community members, with the intention of rallying local support and advocating to local and state politicians. I will primarily pull quantitative data on juvenile detention and incarceration as a whole, including how many juveniles are currently held in confinement (and the types of detention centers) as well as changes since 2000 in the number of youth held in adult prisons. I also plan to use data supporting arts intervention's role in reduced recidivism, skill development, and improved mental health. By the end of the project, the goal is to close on a positive outlook and leave the audience with the understanding that the arts has the potential to change lives.
...
As a reader, I want more policy support for arts programming so that I can change the opinions and outlook on juveniles. I can do this by educating and organizing with my local community and then advocate to our local and state politicians.

Building on my story arc from class, this project would start emotionally low as I introduce the history of incarceration in the United States, coupled with data about the states with the highest detention rates. I would also employ ethos through real stories and case studies. The emotion would continue to deepen as I introduce some of the social stigmas associated with incarceration, including how carceral systems disproportionately affect Black and Brown youth more than white youth.

The story would slowly start to look up as I shift to how arts intervention has been known to help people who have been incarcerated, and how early arts programming could prevent young people from following difficult paths. I would also introduce how much federal funding was allocated to the arts before COVID. However, the emotion would dip slightly again as I show how COVID and administration changes caused arts funding to drop significantly. To bring the story visualization to a close, I would once again employ real life stories from people who have been rehabilitated with the help of arts intervention, including examples from states that have successfully created state level policies supporting arts education in juvenile justice systems.
...
| Arts Education in Juvenile Justice | https://www.aep-arts.org/arts-education-in-juvenile-justice-systems/ | The Arts Education Partnership's resource on arts education in juvenile justice systems to look at how states like Colorado, Indiana, Louisiana, Nevada, and New Jersey have already passed state level policies that support arts programming and education for youth involved in or at risk of entering the justice system. |
